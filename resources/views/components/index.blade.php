...
<head>
    ...
    <link href="{{ asset('/assets/img/logo pdt.png') }}" rel="shortcut icon">
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- CSS File -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/volunteerHome.css') }}" />
...
<body class="font-sans antialiased">
    ...
    <!-- JS File -->
    <script src="{{ asset('/js/volunteerHome.js') }}"></script>
